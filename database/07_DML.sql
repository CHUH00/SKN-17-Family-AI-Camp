...
INSERT INTO tbl_menu VALUES (null, '회냉면', 12000, 4, 'Y');

-- INSERT INTO 테이블명 (컬렴명1, 컬럼명2, 컬럼명3, ...) VALUES (데이터1, 데이터2, 데이터3, ...)
...
-- AUTO_INCREMENT 옵션이 있어도 임의의 PK값 지정 가능 (단, AUTO_INCREMENT 번호 자체에 영향을 줌)
...
-- INTO 키워드는 생략 가능
INSERT INTO tbl_menu VALUES (100, '한방능이100숙', 1000000, 4, 'Y');
REPLACE INTO tbl_menu VALUES (100, '한방능이백숙', 10000, 4, 'Y');
